...
static uint8_t scanRspData[] = {
    ...
    'c', 'h', '5', '7', '2', '_', 'b', 'l', 'e', '_', 'i', 'o', 'c', 'h', 'u', 'b',
...
// GAP GATT Attributes
static uint8_t attDeviceName[GAP_DEVICE_NAME_LEN] = "CH572_ble_iochub";
...
uint8_t DP_LIGHT_CTRL(uint8_t* light_sta)
{
    if(light_sta != NULL)
    {
        if(*light_sta)    GPIOA_ResetBits(LED_LIGHT_PIN);
        else               GPIOA_SetBits(LED_LIGHT_PIN);
    }
